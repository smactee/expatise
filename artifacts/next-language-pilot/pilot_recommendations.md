...
- 8 baseline auto-matches were downgraded before review because Japanese trust-band and risk rules judged them unsafe to trust directly.
- 0 items were rerouted out of generic manual review into create-new or unresolved/delete-style handling.
...
- Downgrade rate on baseline auto-matches: 88.9%.
- Rerouted create-new/unresolved/delete items: 0.
