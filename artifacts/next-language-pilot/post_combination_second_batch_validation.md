...
Generated at 2026-04-18T15:19:24.721Z for `ja/batch-003` on dataset `2023-test1` comparing `original` vs `combination-promoted`.
...
- combination-promoted preflight auto-match ok: 9
- combination-promoted preflight manual review: 24
- combination-promoted preflight likely create-new-question: 1
- combination-promoted preflight likely unresolved: 6
- combination-promoted preflight likely delete: 0
- combination-promoted preflight downgraded: 0
- combination-promoted preflight rerouted: 1
...
- combination-promoted kept matched auto-correct items as auto-match ok: 9
- original exposed matched risky items as auto-match ok: 0
- combination-promoted exposed matched risky items as auto-match ok: 0
...
- combination-promoted image-sign-symbol-mismatch-risk: 20
- combination-promoted topic-subtopic-drift-risk: 11
- combination-promoted trust-band-caution: 5
- combination-promoted combo-image-sign-context-risk: 4
- combination-promoted choice-shape-mismatch: 1
- combination-promoted likely-create-new-question: 1
