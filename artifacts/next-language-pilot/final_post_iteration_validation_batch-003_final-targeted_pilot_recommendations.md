...
- 0 baseline auto-matches were downgraded before review because Japanese trust-band and risk rules judged them unsafe to trust directly.
...
- Downgrade rate on baseline auto-matches: 0%.
