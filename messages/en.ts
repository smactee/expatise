export const en = {
  ...
  onboarding: {
    ...
    cta: 'Get Started',
    location: {
      sheetAria: 'Location selection',
      whereFrom: 'Where are you from?',
      whereLive: 'Where do you live now?',
      country: 'Country',
      province: 'Province',
      city: 'City',
      ...
      noSubdivisions: 'No subdivisions in dataset',
      noCities: 'No cities in dataset',
      back: 'Back',
      next: 'Next',
      done: 'Done',
      saved: 'Saved ✓',
      pinnedLocation: 'Pinned location',
      mapAria: 'Precise location map',
      zoomOut: 'Zoom out',
      preciseKr: 'Precise location (South Korea)',
      useMyLocation: '📍 Use my current location',
      locating: 'Locating you…',
      permissionOff: 'Location permission is off — search your address instead.',
      search: 'Search',
      yourLocation: 'Your location',
      lookupUnavailable: 'Address lookup unavailable right now — tap the map to set your spot.',
      tapToAdjust: 'Tap the map to adjust your exact spot.',
  ...
  questionReview: {
    ...
    countAria: '{count, plural, one {# question} other {# questions}}',
  ...
  qbank: {
    betaNotice:
      '{label} beta currently has {count, plural, one {# translated question} other {# translated questions}} available.',
    taxonomy: {
      topics: {
  ...
  charts: {
    score: {
      ...
      summaryAnswers: '{count, plural, one {# answer} other {# answers}}',
      lowConfidence: 'Low confidence: only {attempts, plural, one {# test} other {# tests}} / {answers, plural, one {# answer} other {# answers}} in this window.',
    },
    screenTime: {
      legendTest: 'Test',
      legendStudy: 'Study',
      ...
      lowConfidenceWeek: 'Low confidence: only {minutes, plural, one {# minute} other {# minutes}} logged this week.',
      lowConfidenceStudy: 'Low confidence: study tracking not enabled yet (showing 0m study).',
      lowConfidenceTimed: 'Low confidence: only {minutes, plural, one {# timed-test minute} other {# timed-test minutes}} detected.',
    },
    dailyProgress: {
      ...
      axisScore: 'Score',
      tooltipAnswered: '{answered} answered · {tests, plural, one {# test} other {# tests}}',
      tooltipAvgScore: 'Avg score:',
      bestDay: 'Best day:',
      bestDayQuestions: '{count, plural, one {# question} other {# questions}}',
    ...
    heatmap: {
      ...
      bestWindowMeta: '({count, plural, one {# test} other {# tests}})',
      confidenceNote: 'Low confidence: only {count, plural, one {# test} other {# tests}} in this window.',
      legendScore: 'Score',
      legendLowToHigh: 'low → high',
      legendConfidence: 'Confidence',
      legendMoreTests: 'more tests = stronger',
      tooltipAvg: 'Avg {score}% · {count, plural, one {# test} other {# tests}}',
  ...
  stats: {
    ...
    readiness: {
      ...
      basedOn: 'Based on {count, plural, one {# question} other {# questions}} answered',
